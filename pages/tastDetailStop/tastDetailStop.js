...
Page({
  ...
  taskStop: function(event) {
    ...
    wx.navigateTo({
      url: '../confirm/confirm?type=stop&tl_number=' + that.data.tl_number + '&tl_id=' + that.data.tl_id + '&tl_finishednum=' + that.data.finishedNumber + '&workShopId=' + that.data.workShopId + '&workShopName=' + that.data.workShopName
    })
  },
