...
Page({
  ...
  taskContinue: function(event) {
    var that = this
    wx.navigateTo({
      url: '../confirm/confirm?type=continue&tl_number=' + that.data.tl_number + '&tl_id=' + that.data.tl_id + '&workShopId=' + that.data.workShopId + '&workShopName=' + that.data.workShopName
    })
  },
